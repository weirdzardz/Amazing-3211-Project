...
add wave -noupdate -expand -group {Program Counter} -radix hexadecimal -subitemconfig {/single_cycle_core_testbench/uut/pc/addr_in(3) {-radix hexadecimal} /single_cycle_core_testbench/uut/pc/addr_in(2) {-radix hexadecimal} /single_cycle_core_testbench/uut/pc/addr_in(1) {-radix hexadecimal} /single_cycle_core_testbench/uut/pc/addr_in(0) {-radix hexadecimal}} /single_cycle_core_testbench/uut/pc/addr_in
...
add wave -noupdate -expand -group Branch /single_cycle_core_testbench/uut/sig_branch_mux
add wave -noupdate -expand -group {Instruction Memory} /single_cycle_core_testbench/uut/insn_mem/insn_out
add wave -noupdate -expand -group {Instruction Memory} /single_cycle_core_testbench/uut/insn_mem/addr_in
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {668156 ps} 0}
...
update
WaveRestoreZoom {620214 ps} {800254 ps}
