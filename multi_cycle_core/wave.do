...
add wave -noupdate -expand -group {Program Counter} -radix unsigned /single_cycle_core_testbench/uut/pc/addr_in
add wave -noupdate -expand -group {Program Counter} -radix unsigned /single_cycle_core_testbench/uut/pc/addr_out
...
add wave -noupdate -expand -group {Mux Branch} -radix hexadecimal /single_cycle_core_testbench/uut/mux_branch/data_out
add wave -noupdate -expand -group {Mux Branch} -radix hexadecimal /single_cycle_core_testbench/uut/mux_branch/data_a
add wave -noupdate -expand -group {Mux Branch} -radix hexadecimal /single_cycle_core_testbench/uut/mux_branch/data_b
add wave -noupdate -expand -group DATAMEM /single_cycle_core_testbench/uut/data_mem/reset
